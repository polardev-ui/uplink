...
2. If you cloned the repo, activate your virtual environment each new terminal session:
...
4. In-app, choose `register` (first time) or `login`.

5. Start chatting. Use `/quit` to exit.
